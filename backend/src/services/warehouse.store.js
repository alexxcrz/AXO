...
const ACTION_PERMISSIONS = {
  ...
  scopeRetailOrdenesCompra: [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailSurtido:       [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailCerrado:      [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailHuellas:       [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailClientes:      [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailInventario:    [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailPrearmado:     [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailIncidencias:   [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  scopeRetailReportes:      [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  viewRetailPurchaseOrders: [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailPurchaseOrders:[ROLE_LEAD, ROLE_SR, ROLE_SSR],
  cancelRetailPurchaseOrders:[ROLE_LEAD, ROLE_SR],
  viewRetailPicking:        [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailPicking:      [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  viewRetailClosing:        [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailClosing:      [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  approveRetailClosing:     [ROLE_LEAD, ROLE_SR],
  printRetailLabels:        [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  reprintRetailLabels:      [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  viewRetailFootprints:     [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailFootprints:   [ROLE_LEAD, ROLE_SR],
  importRetailFootprints:   [ROLE_LEAD, ROLE_SR],
  viewRetailClients:        [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailClients:      [ROLE_LEAD, ROLE_SR],
  viewRetailCatalog:        [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailCatalog:      [ROLE_LEAD, ROLE_SR],
  importRetailCatalog:      [ROLE_LEAD, ROLE_SR],
  viewRetailPreassembly:    [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailPreassembly:  [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  viewRetailIncidents:      [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  manageRetailIncidents:    [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  viewRetailReports:        [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  exportRetailReports:      [ROLE_LEAD, ROLE_SR],
  ...
  manageMaintenanceInventory: [ROLE_LEAD, ROLE_SR],
  deleteMaintenanceInventory: [ROLE_LEAD, ROLE_SR],
  importMaintenanceInventory: [ROLE_LEAD, ROLE_SR],
  viewMaintenanceInventory:   [ROLE_LEAD, ROLE_SR, ROLE_SSR, ROLE_JR],
  accessAuditTabCaptura:      [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  accessAuditTabPropuestas:   [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  accessAuditTabAutorizar:    [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  accessAuditTabSeguimiento:  [ROLE_LEAD, ROLE_SR, ROLE_SSR],
  accessAuditTabHistorial:    [ROLE_LEAD, ROLE_SR, ROLE_SSR],
...
const AREA_TAB_SCOPED_ACTION_CONFIG = [
  ...
  ["scopeRetailDashboard", ["viewRetailReports", "exportRetailReports", "exportDashboardData", "manageDashboardState"]],
  ["scopeRetailOrdenesCompra", ["viewRetailPurchaseOrders", "manageRetailPurchaseOrders", "cancelRetailPurchaseOrders"]],
  ["scopeRetailSurtido", ["viewRetailPicking", "manageRetailPicking"]],
  ["scopeRetailCerrado", ["viewRetailClosing", "manageRetailClosing", "approveRetailClosing", "printRetailLabels", "reprintRetailLabels"]],
  ["scopeRetailHuellas", ["viewRetailFootprints", "manageRetailFootprints", "importRetailFootprints"]],
  ["scopeRetailClientes", ["viewRetailClients", "manageRetailClients"]],
  ["scopeRetailInventario", ["viewRetailCatalog", "manageRetailCatalog", "importRetailCatalog"]],
  ["scopeRetailPrearmado", ["viewRetailPreassembly", "manageRetailPreassembly"]],
  ["scopeRetailIncidencias", ["viewRetailIncidents", "manageRetailIncidents"]],
  ["scopeRetailReportes", ["viewRetailReports", "exportRetailReports"]],
...
function normalizeState(state, previousState = null) {
  ...
  const normalized = {
    ...
    retail: normalizeRetailState(state.retail),
...
function buildSampleState() {
  ...
  return {
    ...
    retail: normalizeRetailState(null),
    updatedAt: new Date().toISOString(),
  };
}
